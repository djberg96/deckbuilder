...
RSpec.describe Card, type: :model do
  ...
  describe '#data' do
    ...
    context 'when stored data contains overly long values' do
      it 'is invalid when a value is longer than 512 characters and reports the offending keys' do
      ...
      it 'is valid when values are exactly 512 characters or shorter' do
